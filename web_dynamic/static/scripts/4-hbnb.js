$(document).ready(function() {
  ...
  $('button').click(function() {
    // AJAX request to fetch places data with checked amenities
    $.ajax({
      url: 'http://0.0.0.0:5001/api/v1/places_search/',
      type: 'POST',
      contentType: 'application/json',
      data: JSON.stringify({ amenities: Object.keys(amenityIDs) }), // Send list of checked amenity IDs in POST data
